...
class RouteChecker {
  ...
  /**
   * Find shortest path between two nodes in system route
   * 
   * @param {String} start 'x_coordinate:y_coordinate'
   * @param {String} end 'x_coordinate:y_coordinate'
   * 
   * @returns {Object} { path: <Array>, weight: <Number> }
   */
  findSystemShortestPath(start, end) {
    return this.systemRoute.findShortestPath(start, end);
  }
}
